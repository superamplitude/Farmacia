...
load_env_file('/home/superamplitude/.farmacia/.env');
...
if (session_status() !== PHP_SESSION_ACTIVE) {
    ...
    session_set_cookie_params(['httponly'=>true,'secure'=>!empty($_SERVER['HTTPS']),'samesite'=>'Lax','path'=>env('APP_BASE','/Farmacia') ?: '/']);
    session_start();
}
